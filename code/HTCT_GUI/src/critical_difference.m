function cd = critical_difference(saveto, s,labels,alpha)
%
...
if nargin < 4
   ...
   alpha = 0.05;% default value of significant level

end

% convert scores into ranks
% N: number of datasets;    k: number of algorithms
[N,k] = size(s);
[S,r] = sort(s');
...
for i=1:ceil(k/2)
   ...
   h = text(1.2, 100 - 5*(n+1)- 10*i + 2, num2str(r(i)), 'FontSize', 10, 'HorizontalAlignment', 'right');
