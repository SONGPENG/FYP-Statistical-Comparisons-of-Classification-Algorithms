...
class Ui_CdWindow(object):
    ...
    def retranslateUi(self, CdWindow):
        ...
        CdWindow.setWindowTitle(_translate("CdWindow", "plot: critical distance"))
        self.pbt_input.setText(_translate("CdWindow", "Input:"))
        self.pbt_output.setText(_translate("CdWindow", "Output:"))
        self.label_dt.setText(_translate("CdWindow", "Data Type:"))
        self.rbt_ar.setText(_translate("CdWindow", "accuracy rate"))
        self.rbt_er.setText(_translate("CdWindow", "error rate"))
